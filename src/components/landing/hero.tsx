    ...
    <section className="relative overflow-hidden pb-16 pt-8 md:pb-24 md:pt-12">
      <div className="section-shell">
        ...
        <figure className="mt-12 md:mt-16">
          ...
          <figcaption className="mt-3 flex items-center justify-between gap-4 text-sm text-faint"><span>There may be something waiting for you among the letters.</span><span className="hidden font-medium uppercase tracking-kicker text-oxblood sm:inline">Fig. 01</span></figcaption>
        </figure>
      </div>
    </section>
  );
