      ...
      <div className="section-shell">
        <div className="stagger-in mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm">
            ...
            >
              Lifetime Subscriptions Available for $100, with the full newsletter plus select future releases and extras as Among The Letters grows.<br />
              Email
        ...
        <figure className="mt-12 md:mt-16">
          <img
            src="./images/hero.jpg"
            alt="A writer's desk with an open book, fountain pen, letters, and coffee in window light."
            className="img-frame aspect-video w-full rounded-2xl object-cover md:aspect-hero"
            width={1792}
            height={1008}
          />
